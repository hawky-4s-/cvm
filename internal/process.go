...
/**
 * Implementation taken from https://github.com/hashicorp/consul-template/blob/master/child/child.go
 */
...
type NewInput struct {
	...
	// ExecCommand is the name of the command to execute. Args are the list of
...
// ExecCommand returns the human-formatted command with arguments.
